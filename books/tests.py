...
class BookTests(TestCase):
    ...
    def test_book_list_view_for_logged_out_user(self):
        ...
        # print("%s?next=/books/" % "http://127.0.0.1:8000/accounts/login/")
        # http://127.0.0.1:8000/accounts/login/?next=/books/
        # It replaces %s with the result of reverse("account_login")
        # Check the url after trying to access books/ without being logged in.
